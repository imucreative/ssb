<?php
	class Shipment extends CI_Controller{
		...
		function post(){
			...
			if(isset($_POST['submit'])){
				if($image){
					...
					$data['error']	= "<strong>Error Upload Data</strong>, Please upload <strong>image/doc/pdf</strong> and max file size not more than <strong>1Mb</strong>";
		...
		function upload_image(){
			...
			$config['allowed_types']	= 'jpg|png|jpeg|pdf|doc|docs';		//type yang dapat diakses bisa anda sesuaikan
			$config['max_size']			= 1024; //1mb
