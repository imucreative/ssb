											...
											<div class="input-group-btn">
												...
												<?php 
													if($row['file']!=""){
														...
														$remove = anchor("admin/shipment/remove_file/".$row['shipment_id'], '<i class="fa fa-trash-o"></i>', ["class"=>"btn btn-danger tooltips", "data-placement"=>'top', "data-original-title"=>'Remove File', "title"=>'Remove File', "onclick"=>"return confirm('Are you sure?')"]);
														...
														<a href='".base_url()."admin/shipment/remove_file/".$row['shipment_id']."' class='btn btn-danger tooltips' data-placement='top' data-original-title='Remove File' title='Remove File'>
															<i class='fa fa-times'></i>
														</a>".$remove;
