				...
				?>
						...
						<td class="col-sm-6" >
							...
							<div class="col-sm-8">
								<div class="input-group">
									<input type="text" data-date-format="yyyy-mm-dd" data-date-viewmode="years" class="form-control" id="form-field-2" placeholder="" name="date_of_shipment" value="<?php echo $row['date_of_shipment'];?>" readonly required />
					...
					<tr>
						<td align='right' colspan="2">
							<div class="col-sm-12">
								<?php
									echo anchor('admin/shipment/list_shipment', "<i class='fa fa-arrow-left'></i> BACK",array('class'=>'btn btn-info btn-sm'));
								?>
							</div>
						</td>
					</tr>
