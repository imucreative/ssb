					...
					<table id="mytable" class="table table-bordered table-hover table-full-width dataTable" cellspacing="0" width="100%">
						<thead>
							<tr>
								...
								<th width='15%'><center>DESTINATION</center></th>
								<th width='15%'><center>CONSIGNEE</center></th>
								<th width='20%'><center>STATUS DESCRIPTION</center></th>
							...
							<?php
								...
								foreach ($shipment as $r){
									...
									//if(($shipHistory['status'] != "DELIVERY")&&($shipHistory['status'] != "COMPLETE")){
										$edit	= anchor('admin/shipment/status_detail/'.$r->shipment_id, '<i class="fa fa-search"></i>', 'class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Detail" title="Detail"');
