											...
											<div class="input-group-btn">
												...
												<?php 
													if($row['file']!=""){
														...
														anchor("admin/shipment/remove_file/".$row['shipment_id'], '<i class="fa fa-trash-o"></i>', ["class"=>"btn btn-danger tooltips", "data-placement"=>'top', "data-original-title"=>'Remove File', "title"=>'Remove File', "onclick"=>"return confirm('Are you sure?')"]);
													}
												?>
											</div>
										</div>
