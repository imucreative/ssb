											...
											<div class="input-group-btn">
												...
												<?php 
													if($row['file']!=""){
														...
														<a href='".base_url()."admin/shipment/download/remove_file/".$row['shipment_id']."' class='btn btn-danger tooltips' data-placement='top' data-original-title='Remove File' title='Remove File'>
															<i class='fa fa-times'></i>
														</a>
														";
