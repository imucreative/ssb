											...
											<div class="input-group-btn">
												...
												<?php 
													if($row['file']!=""){
														...
														<a href='".base_url()."admin/shipment/remove_file/".$row['shipment_id']."' onclick='confirmRemoveFile()' class='btn btn-danger tooltips remove_file' data-placement='top' data-original-title='Remove File' title='Remove File'>
															<i class='fa fa-times'></i>
														</a>";
														
														anchor("admin/shipment/remove_file/".$row['shipment_id'], '<i class="fa fa-trash-o"></i>', ["class"=>"btn btn-xs btn-danger tooltips", "data-placement"=>'top', "data-original-title"=>'Remove File', "title"=>'Remove File', "onclick"=>"return confirm('Are you sure?')"]);
													}
												?>
											</div>
										</div>
