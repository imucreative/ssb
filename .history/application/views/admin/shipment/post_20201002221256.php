				...
				?>
					<tr>
						<td  class="col-sm-6" >
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" id="form-field-1" placeholder="" name="code" limit="20" size="20" required />
							</div>
						</td>
						<td class="col-sm-6" >
							<div align='right' class="col-sm-4">
										...
										<div class="input-group">
											...
											<div class="input-group-btn">
												<div class="btn btn-light-grey btn-file">
													...
													<input type="file" id="form-field-6" name="userfile" class="file-input" accept=".png, .jpg, .jpeg, .doc, .docx, .pdf"/>
												</div>
