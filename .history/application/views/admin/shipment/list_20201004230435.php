							...
							<?php
								...
								foreach ($shipment as $r){
									...
									//if(($shipHistory['status'] != "DELIVERY")&&($shipHistory['status'] != "COMPLETE")){
										$edit	= anchor('admin/shipment/list_detail/'.$r->shipment_id, '<i class="fa fa-search"></i>', 'class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Detail" title="Detail"');
