															...
															<td class="col-sm-6" >
																...
																<div class="col-sm-8">
																	<div class="input-group">
																		<input type="text" data-date-format="dd-mm-yyyy" data-date-viewmode="years" class="form-control" id="form-field-2" placeholder="" name="date_of_shipment" value="<?php echo $track['date_of_shipment'];?>" readonly required />
