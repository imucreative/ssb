							...
							<table class="table">			
								<tr>
									<td class="col-sm-6" >
										...
										<div class="col-sm-6">
											<input type="text" id="code" name="code" class="form-control" maxlength="30" placeholder="* Code Tracking Shipment" value="<?php echo $code;?>" required>
					...
					<div class="row">
						<table class="table">
							<tr>
								<td class="col-sm-12" >
									<div align='right' class="col-sm-3">
										<label class="control-label" for="form-field-1">TRACKING NO NOT FOUND<span class="symbol required"></span></label>
									</div>
