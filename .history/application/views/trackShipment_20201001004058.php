						...
						<table class="table">
							<tr>
								...
								<td class="col-sm-6" >
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" id="form-field-2" placeholder="" name="date_of_shipment" value="<?php echo tgl_indo_short($track['date_of_shipment']);?>" readonly required />
									</div>
								</td>
							</tr>
							<tr>
