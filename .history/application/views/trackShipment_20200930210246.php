							...
							?>
								<div class="row">
									<div class="form-group">
										<div class="col-md-3">
											<input type="text" id="code" name="ncodeame" class="form-control" maxlength="30" placeholder="* Code Tracking Shipment" value="<?php echo $track['code'];?>" required>
										</div>
										<div class="col-md-6">
															...
															<td class="col-sm-6" >
																...
																<div class="col-sm-8">
																	<div class="input-group">
																		<input type="text" data-date-format="yyyy-mm-dd" data-date-viewmode="years" class="form-control" id="form-field-2" placeholder="" name="date_of_shipment" value="<?php echo $track['date_of_shipment'];?>" readonly required />
														...
														<tr>
															...
															<td >
																...
																<div class="col-sm-8">
																	...
																	<a href="<?php echo base_url()."admin/shipment/download/".$track['file'];?>" class='tooltips' data-placement='top' data-original-title='Download File' title='Download File'>
